...
About_LINK | GitHub_LINK | LinkedIn_LINK | Keybase_LINK 
...
A page of weekly quotes link:./quotes[right here]!
...
`+plain text+`. I had to decompress Word files and work with raw XML
