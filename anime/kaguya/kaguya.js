 ...
 * http://schillmania.com/projects/snowstorm/license.txt
  ...
  Modified for https://sandyuraz.com/anime/kaguya
 */
...
var snowStorm = (function (window, document) {
        ...
        this.snowColor = "var(--color-snow)"; // Don't eat (or use?) yellow snow.
        ...
        this.flakeRightOffset = -200; // Right margin/gutter space on edge of container
        ...
        var storm = this,
                ...
                //         try {
                //                 document.createElement("div").style.opacity =
                //                         "0.5";
                //         } catch (e) {
                //                 return false;
                //         }
        ...
        features = (function () {
                ...
                function timeoutShim(callback) {
                        window.setTimeout(
                                callback,
                                1000 / (storm.animationInterval || 20)
                        );
                }
        ...
        this.setXY = function (o, x, y) {
                ...
                if (storm.usePixelPosition || targetElementIsRelative) {
                        ...
                        o.style.top =
                                Math.min(y, docHeight - storm.flakeHeight) +
                                "px";
                } else {
        ...
        this.resizeHandler = function () {
                if (window.innerWidth || window.innerHeight) {
                        screenX =
                                window.innerWidth - 16 - storm.flakeRightOffset;
        ...
        this.resizeHandlerAlt = function () {
                screenX =
                        storm.targetElement.offsetWidth -
                        storm.flakeRightOffset;
        ...
        this.SnowFlake = function (type, x, y) {
                ...
                this.twinkleFrame = 0;
                this.active = 1;
                this.fontSize = 40 + (this.type / 5) * 10;
                ...
                this.recycle = function () {
                        ...
                        s.x = parseInt(
                                rnd(screenX - storm.flakeWidth - 20),
                                10
                        );
                        s.y =
        ...
        this.snow = function () {
                ...
                if (active < storm.flakesMaxActive) {
                        flake =
                                storm.flakes[
                                        parseInt(rnd(storm.flakes.length), 10)
                                ];
                        if (flake.active === 0) {
                                flake.melting = true;
                        }
        ...
        this.start = function (bFromOnLoad) {
                ...
                storm.usePositionFixed =
                        storm.usePositionFixed &&
                        !noFixed &&
                        !storm.flakeBottom; // whether or not position:fixed is to be used
