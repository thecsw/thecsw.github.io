...
* https://github.com/thecsw/morse_thinklight[Thinkpad Speaks in Morse
Code 🆘]
...
* link:./collatz[Generate Collatz Conjecture Graphs 📉]
* https://github.com/thecsw/rjokes[Get Me the Best Reddit Jokes 🃏]
