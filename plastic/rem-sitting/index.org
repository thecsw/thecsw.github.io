...
#+begin_gallery :num 3
- [[https://photos.sandyuraz.com/Vte][From above "the way the tshirt texture falls off is pleasant"]]
- [[https://photos.sandyuraz.com/dwF][Frontal shot "Rem's scene with Subaru... she be real for that"]]
- [[https://photos.sandyuraz.com/rFl][Full height "what a great pose and sculpting done on this figure"]]
#+end_gallery

#+begin_gallery :num 1
- [[https://photos.sandyuraz.com/LLs][Fancy sitting "this is where the two Rems actually are, see adam's post"]]
#+end_gallery
