...
BEGIN_ABSTRACT This is a converted version of my speech I gave at my
public speaking class in college. This speech is meant to persuade its
audience. I truly believe that changing the current marking method of
history can shift the way we thenx and perceive ourselves. The idea
itself was greatly inspired by Kurzgesagt's
