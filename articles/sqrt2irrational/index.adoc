...
website. Finally, I managed to do it by installing `asciidoctor-latex`
and running some quick `Makefile` magic. It looks that it's working
fine! Here is a simple proof that I've come to like over the years.
