...
image::pic1.png[pic1.png, 475, role="left", link="./pic1.png"]
[#pic2]
.My desktop
image::pic2.png[pic2.png, 475, role="right", link="./pic2.png"]
[#pic3]
.Fancy window tiling with cowsay, pipes.sh, htop, neofetch in anti-clockwise order
