...
.Experiment
image::exper.png[Experiment, width=580, role="center", link="exper.png"]

.The Arm
image::tree.png[The Arm, width=580, role="center", link="tree.png"]

.Darya
image::darya.png[Darya, width=580, role="center", link="darya.png"]
