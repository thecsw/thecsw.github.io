...
.Experiment
image::exper.png[Experiment, width=610, role="center", link="exper.png"]

.The Arm
image::tree.png[The Arm, width=610, role="center", link="tree.png"]

.Darya
image::darya.png[Darya, width=610, role="center", link="darya.png"]
