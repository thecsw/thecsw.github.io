...
Assume that the surface latexmath:[$S$] of this pasta is parametrized by
the equations

latexmath:[$\vec{r}(t,a)=\begin{cases}x(t,a)=0.9 t \cos (a)\\y(t,a) = t \sin (a)\\z(t,a) = 0.06\sqrt{t} (1.21\, -t) \sin (22.5 t \cos (a))\\\qquad\qquad-0.08 t^2 \sin (2 a)+\frac{1}{2} t^6-t^4-0.1 t^2+1\end{cases}$]

for latexmath:[$0\leq t \leq 1.21, 0 \leq a \leq 2\pi$]
