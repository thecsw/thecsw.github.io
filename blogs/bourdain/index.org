...
All of the code and examples lead to the [[https://github.com/thecsw/bourdain][source git repository]]. This article has
also been discussed on [[https://news.ycombinator.com/item?id=46258163][hackernews]]. Also, a week before I published this,
/mirandom/ had the same idea as me and published [[https://mirandrom.github.io/bourdain-lists/][their findings]]---go check them
out.
...
=li.st= as closely as possible with *no changes to the content.*
...
9. GRAND HOTEL D'ANGKOR (Siem Reap): I'm a sucker for grand, colonial era hotels
   in Asia.
...
It was surprising to see that only one page was not recoverable from the common
crawl.
