...
.tmux
image::pic1.png[tmux, width=610, role="center", link="pic1.png"]

.My desktop

.screen
image::pic2.png[screen, width=610, role="center", link="pic2.png"]

.i3 with cowsay, pipes.sh, htop, neofetch in counterclockwise order

.programs
image::pic3.png[programs, width=610, role="center", link="pic3.png"]
