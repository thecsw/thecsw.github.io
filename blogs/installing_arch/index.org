...
=wifi-menu=, =rankmirrors=, and else. In general, instructions below would give you
the correct installation, you would just have to fill out some of the gaps
yourself. Good luck 😘
...
PIC pic3.png:i3 with cowsay, pipes.sh, htop, neofetch in counterclockwise order
